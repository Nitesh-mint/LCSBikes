<?php
/**
 * Plugin Name: Solid Performance Advanced Cache Drop-In
 * Plugin URI: https://go.solidwp.com/performance-author
 * Description: A Solid Performance drop-in that enhances site performance by caching responses, reducing server load, and minimizing response times.
 * Version: 1.8.0
 * Author: SolidWP
...
define( 'SWPSP_ADVANCED_CACHE', (bool) realpath( WP_CONTENT_DIR . '/plugins/solid-performance/solid-performance.php' ) );
define( 'SWPSP_ADVANCED_CACHE_VERSION', '1.8.0' );

if ( SWPSP_ADVANCED_CACHE ) {
	// 1. Initialize Required Dependencies.
	require_once WP_CONTENT_DIR . '/plugins/solid-performance/vendor/vendor-prefixed/autoload.php';
	require_once WP_CONTENT_DIR . '/plugins/solid-performance/src/functions/app.php';
	require_once WP_CONTENT_DIR . '/plugins/solid-performance/src/functions/filesystem.php';
	require_once WP_CONTENT_DIR . '/plugins/solid-performance/src/functions/config.php';
	...
	spl_autoload_register(
		static function ( $path ): void {
			...
			$file = WP_CONTENT_DIR . "/plugins/solid-performance/{$path}.php";
